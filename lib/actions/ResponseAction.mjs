...
export class ResponseAction {
    ...
    static getMessages(text, context) {
        ...
        const assistantInfo = `You give your best to be nice, you are allowed to be funny and charming. You are technically allowed to use emojis, but emoticons are greatly preferred.`;
