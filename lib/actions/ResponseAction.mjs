...
export class ResponseAction {
    ...
    static getMessages(text, context) {
        const systemPrompt = `You are a virtual assistant called ${context.assistant.name}. Your language is ${context.assistant.language}. If the user says something that you understand, ` +
            "you respond with a message that responds to it and the given context and message history.";
        const userPrompt = text;
        const assistantInfo = `You give your best to be nice, you are allowed to be funny and charming. You are technically allowed to use emojis, but emoticons (like :D, ;), etc.) are greatly preferred.`;
