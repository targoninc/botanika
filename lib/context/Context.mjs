...
export class Context {
    ...
    static getOpenAiCompatibleToolFunctions() {
        return [
            ToolBuilder.function("saveInfo")
                .description("Saves the given information to the user's profile.")
                .parameters(ToolParameter.object()
                    .property("name", "string", "The field to modify. Can be 'assistant.name', 'assistant.language', 'user.name' or 'user.language' or any other field that seems appropriate.")
