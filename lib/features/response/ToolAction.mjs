...
export class ToolAction {
    ...
    static getToolMessages(text, context) {
        ...
        const toolInfo = `Call a tool function if it seems sensible to do so. E.g. if the weather is requested, call the weather function or if something related to music is requested, call the according function.`;
